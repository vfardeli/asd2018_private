...
public class TotalStudentsWithScholarshipExtractorTest {
    TotalStudentsWithScholarshipExtractor extractor;

    @Before
    public void init() {
        extractor = new TotalStudentsWithScholarshipExtractor();
    }
